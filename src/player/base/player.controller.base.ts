...
export class PlayerControllerBase {
  ...
  async create(@common.Body() data: PlayerCreateInput): Promise<Player> {
    return await this.service.create({
      data: data,
      select: {
        bothFeetEquipmentSlot: true,
        bothHandsEquipmentSlot: true,
        createdAt: true,
        headEquipmentSlot: true,
        id: true,
        leftFootEquipmentSlot: true,
        leftHandEquipmentSlot: true,
        rightFootEquipmentSlot: true,
        rightHandEquipmentSlot: true,
        updatedAt: true,
      },
    });
  }
